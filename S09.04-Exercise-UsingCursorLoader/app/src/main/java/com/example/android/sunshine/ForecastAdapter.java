...
//      COMPLETED (8) Display the summary that you created above
       ...
       long rawDate = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
       String dateString = SunshineDateUtils.getFriendlyDateString(mContext, rawDate, false);

       int weatherId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
       String weatherDescription = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherId);

       double temperatureHigh = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
       double temperatureLow = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
       String temperatureString = SunshineWeatherUtils.formatHighLows(mContext, temperatureHigh, temperatureLow);

       String weatherSummary = dateString + " - " + weatherDescription + " - " + temperatureString;
