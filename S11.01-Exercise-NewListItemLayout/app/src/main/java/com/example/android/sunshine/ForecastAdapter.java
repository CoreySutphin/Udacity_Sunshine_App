...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        String highStringA11y = mContext.getString(R.string.a11y_high_temp, highString);
         /* Read low temperature from the cursor (in degrees celsius) */
        double lowInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius);
        String lowStringA11y = mContext.getString(R.string.a11y_low_temp, lowString);
        ...
        forecastAdapterViewHolder.weatherHighTemperature.setText(highString);
        forecastAdapterViewHolder.weatherHighTemperature.setContentDescription(highStringA11y);

        forecastAdapterViewHolder.weatherLowTemperature.setText(lowString);
        forecastAdapterViewHolder.weatherLowTemperature.setContentDescription(lowStringA11y);
...
//          COMPLETED (6) Get references to all new views and delete this line
            ...
            weatherHighTemperature = (TextView) view.findViewById(R.id.high_temperature);
            weatherLowTemperature = (TextView) view.findViewById(R.id.low_temperature);
